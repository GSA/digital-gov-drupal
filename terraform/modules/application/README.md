...
| [cloudfoundry_service_instance.this](https://registry.terraform.io/providers/cloudfoundry-community/cloudfoundry/latest/docs/data-sources/service_instance) | data source |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_additional_environmental_variables"></a> [additional\_environmental\_variables](#input\_additional\_environmental\_variables) | Additional environmental variables for the application Useful for dynamic information, like Terraform generated variables. | `map(string)` | `{}` | no |
