        ...
        environment = {
          ...
          ALLOWED_IPS_CMS = base64encode(
             jsonencode([
              ...
              "location = /update.php { allow 149.142.0.0/16; allow 149.143.0.0/16; allow 149.144.0.0/16; allow 159.142.0.0/16; allow 192.168.50.0/24; proxy_pass ${local.cms_fqdn}; }",
            ])
          )
